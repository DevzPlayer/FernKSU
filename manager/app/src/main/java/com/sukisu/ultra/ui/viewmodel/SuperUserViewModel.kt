package com.fern.ksu.ui.viewmodel
...
import com.fern.ksu.ui.util.HanziToPinyin
...
import com.fern.ksu.ui.webui.getInstalledPackagesAll
...
enum class AppCategory(val displayNameRes: Int, val persistKey: String) {
    ALL(com.fern.ksu.R.string.category_all_apps, "ALL"),
    ROOT(com.fern.ksu.R.string.category_root_apps, "ROOT"),
    CUSTOM(com.fern.ksu.R.string.category_custom_apps, "CUSTOM"),
    DEFAULT(com.fern.ksu.R.string.category_default_apps, "DEFAULT");
...
enum class SortType(val displayNameRes: Int, val persistKey: String) {
    NAME_ASC(com.fern.ksu.R.string.sort_name_asc, "NAME_ASC"),
    NAME_DESC(com.fern.ksu.R.string.sort_name_desc, "NAME_DESC"),
    INSTALL_TIME_NEW(com.fern.ksu.R.string.sort_install_time_new, "INSTALL_TIME_NEW"),
    INSTALL_TIME_OLD(com.fern.ksu.R.string.sort_install_time_old, "INSTALL_TIME_OLD"),
    SIZE_DESC(com.fern.ksu.R.string.sort_size_desc, "SIZE_DESC"),
    SIZE_ASC(com.fern.ksu.R.string.sort_size_asc, "SIZE_ASC"),
    USAGE_FREQ(com.fern.ksu.R.string.sort_usage_freq, "USAGE_FREQ");
